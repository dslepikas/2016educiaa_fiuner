 ...
 * -----------------------------------------------------------
 * 20160513 v0.0.2 initials initial version
 * Se señala Ejecuta_RIT() -> LPC4337, IRQ11
 */
...
void (* const g_pfnVectors[])(void) = {
   ...
   ISR_NoHandler, //Ejecuta_RIT,      /* 0x1b 0x0000006C - No Handler set for ISR RIT (IRQ 11) */
